...
class radiance_lite_breadcumb_class {

    var $opts;

    function radiance_lite_custom_breadcrumb() {
        ...
        echo '<section class="cont_nav"><div class="cont_nav_inner"><p><a href="' . esc_url(home_url('/')) . '/">' . __('Home', 'radiance-lite') . '</a>';
        ...
        $output = $this->radiance_lite_simple_breadcrumb_case($post);
    ...
    function radiance_lite_simple_breadcrumb_case($der_post) {
        ...
        if (is_page()) {
            ...
            if ($der_post->post_parent) {
                ...
                $this->radiance_lite_simple_breadcrumb_case($my_query);
        ...
        if (is_author()) {
            ...
            return __('Author', 'radiance-lite') . ' : ' . $curauth->display_name;
        ...
        if (is_tag()) {
            ...
            return __('Tag', 'radiance-lite') . ' : ' . single_tag_title('', false);
        ...
        if (is_search()) {
            ...
            return __('Search', 'radiance-lite');

        }

		if (is_404()) {            return __('Error 404', 'radiance-lite');        }
