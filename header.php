			...
			<!-- 					<div class="top-search col-md-1 col-sm-1 col-xs-3">						
								...
								<?php if( has_nav_menu( 'Header' ) ) {
									...
									<ul id="menu-main" class="max-menu">
										...
										<li class="home-nav"><a href="#section1"><?php _e('About Us', 'radiance-lite'); ?></a></li>
										<li class="home-nav"><a href="#section2"><?php _e('We Serve', 'radiance-lite'); ?></a></li>
										<li class="home-nav"><a href="#section3"><?php _e('Section Three', 'radiance-lite'); ?></a></li>
