...
if( $_first_landing_page_ID != '' && $_first_landing_page_ID != '0' ) {
	...
	$_first_landing_page_title = __('FIRST LANDING PAGE', 'radiance-lite');
...
<div id="section1" class="skt-default-page"><div class="skt-page-overlay"></div>
	...
	<div class="container post-wrap rpage_wrap" style="">
		<div class="row-fluid">
			<div class="title"><h2><?php echo esc_attr($_first_landing_page_title); ?></h2><span class="horizontal-style"></span></div>
			<div class="post">
